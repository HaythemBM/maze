...
function showResult(){
   /*  info_box.classList.remove("activeInfo"); //hide info box */
    ...
    if (userScore > 2){ // if user scored more than 3
        ...
        let scoreTag = '<span>and nice , You got <p>'+ userScore +'</p> out of <p>'+ questions.length +'</p><br>Now turn to the right</br></span>';
...
function showResult(){
   /*  info_box.classList.remove("activeInfo"); //hide info box */
    quiz_box2.classList.remove("activeQuiz"); //hide quiz box
    result_box2.classList.add("activeResult"); //show result box
    const scoreText = result_box2.querySelector(".score_text2");
    if (userScore > 2){ // if user scored more than 3
        //creating a new span tag and passing the user score number and total question number
        let scoreTag = '<span>and congrats! , You got <p>'+ userScore +'</p> out of <p>'+ questions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;  //adding new span tag inside score_Text
